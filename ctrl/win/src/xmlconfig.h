...
public:
	...
	explicit XMLConfig(const QByteArray &, bool = true);
	~XMLConfig();

	const DOMNode*	root	()						const { return m_aptrXMLDOMParser->getDocument()->getDocumentElement(); }
	const DOMNode*	first	( const DOMNode * = 0	)	const;
	const DOMNode*	next	( const DOMNode * = 0	)	const;
	...
	QString gattr( const QString & ) const;
	QString attr(const QString &, const QString & = "name", const QString & = "value");
	QString attr(const DOMNode *, const QString &, const QString &, const QString &, const QString & ) const;
	QString gattr(const QString &, const QString &, const QString &, const QString & ) const;
...
private:
	...
	static const DOMNode* getNodeAttribute(const DOMNode *, const QString &);
