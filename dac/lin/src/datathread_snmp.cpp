...
int					CSNMPThread::m_iDebugLevel	= 8; // нет отладки
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void CSNMPThread::run() {
	...
	while(!m_bStop) {
		...
		for(p= m_ptrmapParameters->begin();p!=e;++p) { 
			// параметр принадлежит данной нити (SNMP) и требует обновления на текущем такте
			if	(
					// принадлежит данной нити
					p.value()->getQueryType() == m_eType &&
					(
						// требует обновления на данном такте
						(
