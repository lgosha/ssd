...
class CParameterIntegratedCreator : public CParameterAbstractCreator {
public:
	virtual CParameter *		createIntPar	( const CParameterDefinition * );
	virtual CParameter *		createStrPar	( const CParameterDefinition * );
	virtual CParameter *		createDoublePar	( const CParameterDefinition * );
...
class CParameterGroupCreator : public CParameterAbstractCreator {
public:
	virtual CParameter *		createIntPar	( const CParameterDefinition * );
	virtual CParameter *		createStrPar	( const CParameterDefinition * );
	virtual CParameter *		createDoublePar	( const CParameterDefinition * );
	...
	virtual bool isValidParameterDefinition( const CParameterDefinition * );
};
